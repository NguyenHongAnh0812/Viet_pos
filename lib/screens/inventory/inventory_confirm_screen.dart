            ...
            child: ElevatedButton(
              onPressed: () async {
                  ...
                  builder: (context) {
                    return StatefulBuilder(
                      builder: (context, setState) {
                        return AlertDialog(
                          title: const Text('Cập nhật tồn kho', style: TextStyle(fontWeight: FontWeight.bold)),
                          content: Column(
                            mainAxisSize: MainAxisSize.min,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                                'Sau khi cập nhật, dữ liệu kho sẽ thay đổi và không thể hoàn tác. Bạn có chắc chắn?',
                ...
                if (confirmed == true) {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Đã cập nhật tồn kho!'), backgroundColor: Colors.green));
                    // Quay về màn danh sách kiểm kê
