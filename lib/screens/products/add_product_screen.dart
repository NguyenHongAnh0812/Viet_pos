            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Giá', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFF2563EB))),
                ],
              ),
              const SizedBox(height: space16),
              Row(
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Tồn kho', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFF059669))),
                ],
              ),
              const SizedBox(height: space16),
              _buildFormField(label: 'Số lượng', controller: _quantityController, keyboardType: TextInputType.number),
